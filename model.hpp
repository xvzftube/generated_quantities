...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in '/home/user/stan/genq/model.stan', line 7, column 2 to column 17)",
                                                      " (in '/home/user/stan/genq/model.stan', line 3, column 6 to column 17)",
                                                      " (in '/home/user/stan/genq/model.stan', line 2, column 19 to line 4, column 4)"};


template <typename T0__>
stan::promote_args_t<T0__>
sq(const T0__& x, std::ostream* pstream__) {
...
(void) function__;  // suppress unused var warning
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"a\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]";
    return s__.str();
